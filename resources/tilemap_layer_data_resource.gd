...
func _load_data(window: Window) -> void:
	...
	if scene_node != null:
		...
		tilemap_layer.set_cells_terrain_connect(tilemap_layer_user_cells, terrain_set, terrain, true)
